...
public class DaishoSayaRenderer extends GeoItemRenderer<DaishoSayaItem> {
	...
	static {
		...
		// TUNING.put(ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, new ItemPoseTuning.Entry(0f, 0f, 0f, 0f, 180f, 0f, 1f));
		// TUNING.put(ItemDisplayContext.THIRD_PERSON_LEFT_HAND, new ItemPoseTuning.Entry(0f, 0f, 0f, 0f, 180f, 0f, 1f));
